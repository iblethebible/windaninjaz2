...
echo $cur_date;
 ...
 INSERT INTO job_history (job_id, dateDone) VALUES ('$job_id', '$cur_date')";
...
if (isset($_GET["submit_three"])) {


$sql3 = "UPDATE job SET paid = 1 WHERE id = $job_id";
...
$payButton = '<form action="jobupdate.php" method="get"><input type="hidden" name="id" value="'.$job_id.'"><input class="btn btn-success" type="submit" name="submit_three" value="JOB PAID"></form>';
...
<div class="col-sm">
<?php
$jobcompleteunpaid = '<form action="jobupdate2.php" method="get"><input type="hidden" name="id" value="'.$job_id.'"><input id ="unpaid-button" class="btn btn-warning "type="submit" name="submit_button" value="JOB COMPLETE/UNPAID">';
?>
<?php 
$tempDate = $dateNextDue - $job_frequency_days;
if ($ispaid == 0) {
